...
<div class="container">
  ...
  <form action="processa_mbti.php" method="POST">
    ...
    foreach ($perguntas as $index => $p) {
        ...
        $opcoes = [
            1 => ["texto" => "Concordo totalmente", "classe" => "maior"],
            2 => ["texto" => "Concordo", "classe" => "medio"],
            3 => ["texto" => "Neutro", "classe" => "menor"],
            4 => ["texto" => "Discordo", "classe" => "medio"],
            5 => ["texto" => "Discordo totalmente", "classe" => "maior"]
        ];
        ...
        foreach ($opcoes as $valor => $opcao) {
            ...
            echo '<input type="radio" name="resposta_' . ($index + 1) . '" value="' . $valor . '-' . $letra . '">';
    ...
    <div style="text-align: center; margin-top: 30px;">
      <button type="submit" style="padding: 12px 30px; font-size: 16px; background-color: #D25050; color: white; border: none; border-radius: 12px; cursor: pointer;">
        Ver meu Tipo MBTI
      </button>
    </div>
  </form>
