...
<header class="header">
  ...
  <div class="container">
    ...
    <form action="salvar_projeto.php" method="POST">
      <input type="text" name="projeto" placeholder="Descreva seu sonho..." required><br><br>
      <button type="submit" class="start-button">Adicionar</button>
    </form>
    <br>
    <?php include 'listar_projetos.php'; ?>
  </div>
